...
const kPrivacyPolicyUrl = 'https://fpdlv12-dev.github.io/photo_calendar/privacy-policy.html';
    ...
    return Scaffold(
      ...
      body: ListenableBuilder(
              ...
              builder: (context, _) => ListView(
                ...
                children: [
                  _section(context, t.settingsMonthPhotos, t.settingsMonthPhotosSubtitle),
                  PhotoModeSelector(
                  ...
                  SegmentedButton<int>(
                    segments: [
                      ButtonSegment(value: DateTime.sunday, label: Text(t.weekStartSunday)),
                      ButtonSegment(value: DateTime.monday, label: Text(t.weekStartMonday)),
                    ],
                  ...
                  FutureBuilder<PackageInfo>(
                    ...
                    builder: (context, snap) => ListTile(
                      ...
                      subtitle: Text(t.settingsVersion(
